...
export const timelineItems: TimelineItem[] = [
  ...
  { id: 'cmpe275-mini1', branch: 'cmpe275', parentBranch: 'ms', start: '2025-02', end: '2025-03', track: 'project', title: 'CMPE 275 · Mini 1', description: 'Distributed computing coursework — benchmarked Array-of-Objects vs. Object-of-Arrays CSV parser layouts on NYC crash data, OpenMP-parallelized both, then optimized cache locality with a values-only struct for a 55.5% runtime improvement over the naive baseline.', tags: ['C++', 'OpenMP'], status: 'completed', link: 'https://github.com/manamsriram/mini1', visible: true },
  { id: 'cmpe275-mini2', branch: 'cmpe275', parentBranch: 'ms', start: '2025-03', end: '2025-04', track: 'project', title: 'CMPE 275 · Mini 2', description: 'Distributed computing coursework — 5-node one-way pipeline mesh over gRPC/Protobuf for streaming and processing crash records, with a Python client driving the C++ server fleet.', tags: ['C++', 'gRPC', 'Protobuf', 'Python'], status: 'completed', link: 'https://github.com/manamsriram/mini2', visible: true },
  { id: 'cmpe275-mini3', branch: 'cmpe275', parentBranch: 'ms', start: '2025-04', end: '2025-05', track: 'project', title: 'CMPE 275 · Mini 3', description: 'Distributed computing coursework — replicated key-value store rewritten in Python over a full-mesh gRPC topology, with RAFT-style leader election, resource-based scoring, replication factor 2, and self-healing topology repair. Tested across two machines over a switched Ethernet link at up to 1M rows.', tags: ['Python', 'gRPC', 'RAFT', 'Distributed Systems'], status: 'completed', link: 'https://github.com/manamsriram/cmpe275', visible: true },
  { id: 'cmpe275-final', branch: 'cmpe275', parentBranch: 'ms', start: '2025-05', track: 'project', title: 'CMPE 275 · Distributed Video Encoding (Final Project)', description: 'Co-led the whole class (~40 students, 10 teams) on the semester final: a master/worker gRPC platform sharding and FFmpeg-encoding video across dynamically-joining worker nodes. Our team owned the gRPC connection-lifecycle fixes and rebuilt leader election for dynamic membership; validated live across 6 machines and multiple switches.', tags: ['Python', 'gRPC', 'FFmpeg', 'RAFT', 'Distributed Systems'], status: 'completed', link: 'https://github.com/manamsriram/video_encoding_cmpe275', visible: true },
